...
//defined('DOMAIN') or define('DOMAIN','.blog.com');
defined('DOMAIN') or define('DOMAIN','.quanjiaxin.cn');
...
//静态资源地址
defined("_STATIC_") or define("_STATIC_","http://test-static" . DOMAIN . "/" . THEME . '/');

//上传文件地址
defined("_UPLOAD_") or define("_UPLOAD_","http://test-static" . DOMAIN . "/upload" . '/');
//接口网址
defined("_SERVICE_") or define("_SERVICE_","http://test-services" . DOMAIN);
//前台网址
defined("_FRONT_") or define("_FRONT_","http://test-www" . DOMAIN);
//后台地址
defined("_BACKEND_") or define("_BACKEND_","http://test-manager" . DOMAIN);
