 ...
 * @version   $Id: Image.class.php 3005 2012-06-17 15:33:22Z luofei614@gmail.com $
  +------------------------------------------------------------------------------
 */
class Image {
     ...
     * @return string
      +----------------------------------------------------------
     */
    static function buildImageVerify($length=4, $mode=1, $type='png', $width=48, $height=22, $verifyName='verify',$randval=null) {
        import('ORG.Util.String');
        if (empty($randval)) $randval = String::randString($length, $mode);
        else $length=strlen($randval);
